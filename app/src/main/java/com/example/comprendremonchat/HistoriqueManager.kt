...
private val Context.historiqueDataStore by preferencesDataStore(name = "historique_bilans_chat")
...
object HistoriqueManager {
    ...
    private val HISTORIQUE_KEY = stringPreferencesKey("historique_bilans_chat_json")
